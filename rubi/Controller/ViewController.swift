...
extension ViewController : AuthenticationControllerProtocol {
    ...
    func checkFormStatus() {
        if viewModel.formIsVaild {
            ...
            goNextButton.backgroundColor = #colorLiteral(red: 0.1019607857, green: 0.2784313858, blue: 0.400000006, alpha: 1)
        }else {
            goNextButton.isEnabled = false
            goNextButton.backgroundColor = #colorLiteral(red: 0.5058823824, green: 0.3372549117, blue: 0.06666667014, alpha: 1)
        }
    }
}
